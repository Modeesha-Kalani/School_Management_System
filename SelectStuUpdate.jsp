...
<div class="wrapper">
		<center><h3 class="heading"><img src="logos/select2.png" style="height:50px;width:50px">Select Edit Register</h3></center>
		<br><br>
<form action="ViewAttendanceUpdateServlet" method="post">
		<center>
		<div class="home">
		<table border="0">
			<tr>
				<td><label>Input Date :</label></td>
				<td><input type="date" class="date" name="date" Style="width: 140px" required="required"></td>
			<tr>
				<td><label class="FormTxt">Input Grade :</label></td>
				<td>
					<select name="grade" id="grade" Style="width: 140px">
			...
			<tr>
				<td><label class="FormTxt">Input Class :</label></td>
				<td>
					<select name="className" id="ClassName" Style="width: 140px">
