...
<div class="wrapper">
		<center><img src="logos/delete.png" style="height:50px;width:50px"><h3 class="heading">Delete Attendance</h3></center>

<form action="DeleteStuAttendance" method="post">
	<%
	...
	<table class="Regtable"  style="width:500px;">
		...
		<tr class="Regtable">
		<td class="Regtable">Attendance Status :</td><td class="Regtable"><%=attendance %></td>
		</tr>
	</table>
	<input class="btnAtSubmit" type="submit" name="submit" value="Confirm Delete">
	</div>
	</form>
